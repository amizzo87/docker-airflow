...
ARG ADDITIONAL_PYTHON_DEPS="boto3 requests==2.23.0 pandas numpy haversine delorean google-cloud-bigquery google-auth stripe zenpy fastparquet pyarrow google-cloud-automl google-cloud-pubsub beautifulsoup4 google-cloud-storage"
